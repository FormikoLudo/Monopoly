...
/**
 * The following class represents the help controller on which you can find luxury taxe explanatory.
 */
public class LuxuryTaxeHelpController
{

  /**
   * label containing the explanatory text of the luxury taxe.
   */
  @FXML private Label luxuryTaxeLabel;
  ...
  public void initialize()
  {
    ...
    luxuryTaxeLabel.setText("     Sur le plateau du Monopoly se trouve la Taxe de luxe. Si vous tombez sur celle-ci, vous devrez payer une somme définie de 100$ à la banque. \n\n" +
