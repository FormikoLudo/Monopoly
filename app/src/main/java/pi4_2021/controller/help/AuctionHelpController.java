...
/**
 * The following class represents the help controller on which you can find auction help.
 */
public class AuctionHelpController
{
  ...
  public void initialize()
  {
    ...
    auctionLabel.setText("       Une mise aux enchères a lieu lorsqu’un joueur tombe sur une propriété qui n’appartient à personne et qu’il choisit de ne pas en faire l’acquisition. \n\n" +
                        "        Les autres joueurs choisissent s’ils veulent ou non participer à la vente aux enchères et la propriété revient au joueur qui aura investi le plus.  \n\n" +
                          "         Des accords entre les joueurs existent aussi, en effet, un joueur peut proposer à un autre de lui racheter sa propriété en lui proposant un prix. \n\n");
  }
